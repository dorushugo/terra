        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-16">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white/60 text-white hover:bg-white hover:text-urban-black font-terra-body font-medium px-8 py-4 text-base transition-all duration-200"
            >
              Notre impact
            </Button>
          </div>
